...
typedef void(*EventFunc) (u32 tStates, int type, void* data);
...
int eventRegister(EventFunc func, const char* description);

void eventAddWithData(u32 time, int type, void* data);

void eventAdd(u32 time, int type)
{
    eventAddWithData(time, type, 0);
}
